...
function  save() {
	...
	if (fullname ==="" ){
		...
		document.getElementById('fullname-error').innerHTML='❗ Nhỏ hơn 50 kí tự ';
			...
			document.getElementById('fullname-error').innerHTML=' ✔️';
	}
	//check mail
	if (email ==="" ){
		...
		document.getElementById('email-error').innerHTML='❗ Email sai định dạng ';
			...
			document.getElementById('email-error').innerHTML=' ✔️';
	}
	//check phone
	if (phone ==="" ){
		...
		phone = '';
		document.getElementById('phone-error').innerHTML='❗ Phone sai định dạng ';
	}else{
			document.getElementById('phone-error').innerHTML='  ✔️';
	}
	//check diem
	if (point ==="" ){
		...
		document.getElementById('point-error').innerHTML='❗ Điểm không đúng định dạng ';
			...
			document.getElementById('point-error').innerHTML=' ✔️';
	}
	// check dia chi 	
	if (address ==="" ){
		...
		document.getElementById('address-error').innerHTML='❗ Nhỏ hơn 50 kí tự ';
			...
			document.getElementById('address-error').innerHTML='✔️';
	}
	//check gender
	if (gender === ""  ){
		document.getElementById('gender-error').innerHTML='❗ Mời bạn chọn giới tính ';
	}else{
			document.getElementById('gender-error').innerHTML=' ✔️';
	}
